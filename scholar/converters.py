...
class MarkdownToLaTeXConverter(Converter):
    def __init__(
        ...
        make_latex_table_pandoc_filter_file: Path,
        cache_dir: Path,
    ) -> None:
        ...
        self.make_latex_table_pandoc_filter_file = make_latex_table_pandoc_filter_file
    ...
    def _run_pandoc(self, input_file: Path, output_file: Path) -> None:
        ...
        subprocess.run(
            [
                ...
                "--filter",
                str(self.make_latex_table_pandoc_filter_file),
                # Other options

...
\usepackage{longtable} % Used in LaTeX tables generated by a custom Pandoc filter "make_latex_table"
\usepackage{array} % Used in LaTeX tables generated by a custom Pandoc filter "make_latex_table"
\usepackage{booktabs} % Used in LaTeX tables generated by a custom Pandoc filter "make_latex_table"
...
% "customTableContinuation" style is used in LaTeX tables
% generated by a custom Pandoc filter "make_latex_table"
\DeclareCaptionLabelFormat{customTableContinuation}{\emph{Продолжение таблицы #2}}
\DeclareCaptionStyle{customTableContinuation}{
  format=plain,
  labelformat=customTableContinuation,
  labelsep=none,
  textformat=empty,
  justification=justified,
  singlelinecheck=false,

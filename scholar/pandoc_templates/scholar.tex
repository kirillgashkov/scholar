...
\usepackage[newfloat,outputdir=$scholar.constants.minted_outputdir$]{minted}
...
\newenvironment{scholar@section@main}{%
  $if(scholar.variables.disable_main_section_numbering)$$else$\makeatletter\c@secnumdepth=0\makeatother$endif$%  % (Conditionally) disable section numbering. Using \c@secnumdepth=0 instead of \setcounter{secnumdepth}{0} to have the counter restored at the end of the environment. (See the comments to https://tex.stackexchange.com/a/11669.)
...
\usepackage[warnings-off={mathtools-colon,mathtools-overbracket}]{unicode-math}  % (See https://tex.stackexchange.com/q/570548.)

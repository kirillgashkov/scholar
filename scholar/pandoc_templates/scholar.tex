...
\pretocmd{\section}{\clearpage}{}{\GenericError{}{Command patching failed}{}{}}

%
% Floats (figures, tables, listings)
%

% Remove the extra vertical space from the bottom of floats
% (see https://tex.stackexchange.com/q/32614)
\RequirePackage{etoolbox}
\AfterEndEnvironment{figure}{\kern \dimexpr -\baselineskip + 1.6ex \relax}
% \AfterEndEnvironment{table}{\kern \dimexpr -\baselineskip + 1.6ex \relax} % FIXME: Probably uncomment
% \AfterEndEnvironment{listing}{\kern \dimexpr -\baselineskip + 1.6ex \relax} % FIXME: Probably uncomment
...
\setlength{\textfloatsep}{\dimexpr \baselineskip - 1.6ex + 0.5\baselineskip \relax}
\setlength{\floatsep}{\dimexpr \baselineskip - 1.6ex + 0.5\baselineskip \relax}
\setlength{\intextsep}{\dimexpr \baselineskip - 1.6ex + 0.5\baselineskip \relax}

% Make floats always appear after their definition
\usepackage{flafter}

% Prevent floats from crossing their section,
% subsection, or subsubsection divisions
\usepackage{placeins}
\RequirePackage{etoolbox}
\pretocmd{\section}{\FloatBarrier}{}{\GenericError{}{Command patching failed}{}{}}

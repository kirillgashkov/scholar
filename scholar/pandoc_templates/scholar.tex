...
% Remove extra vertical space before ToC/LoF/LoT entries (ГОСТ 7.32-2017 5.4.1).
...
% Use regular text titles for ToC/LoF/LoT entries (ГОСТ 7.32-2017 5.4.1). (Some had boldface titles.)
...
% Enable the dots of ToC/LoF/LoT entry dot leaders (ГОСТ 7.32-2017 5.4.1). (Some had dots disabled with "\cftnodots" instead of "\cftdotsep".)
...
% Use regular text dot ledgers for ToC/LoF/LoT entries (ГОСТ 7.32-2017 5.4.1). (Some had boldface dot leaders.)
...
% Use regular text page numbers for ToC/LoF/LoT entries (ГОСТ 7.32-2017 5.4.1). (Some had boldface page numbers.)

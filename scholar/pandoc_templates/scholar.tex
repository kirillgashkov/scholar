...
\BeforeBeginEnvironment{longlisting}{\vspace{\bigskipamount}}
\AfterEndEnvironment{longlisting}{\vspace{\bigskipamount - 0.5\baselineskip}}  % WTF: Assuming caption is above and get extra vertical spacing from "after 'minted' environment".

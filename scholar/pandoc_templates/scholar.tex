...
\RequirePackage[
  backend=biber,      % Explicitly set the backend to Biber.
  datamodel=scholar,  % Use the custom datamodel defined in "scholar.dbx".
  style=numeric,      % Use numeric citations (GOST).
  autocite=inline,    % Make "\autocite" behave like "\parencite".
  labelnumber=true,   % Provide the special field "labelnumber".

...
CONVERT_SVG_TO_PDF_PANDOC_JSON_FILTER_FILE = PANDOC_JSON_FILTERS_DIR / "convert_svg_to_pdf.py"
MAKE_LATEX_TABLE_PANDOC_JSON_FILTER_FILE = PANDOC_JSON_FILTERS_DIR / "make_latex_table.py"

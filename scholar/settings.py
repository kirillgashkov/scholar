...
TRIM_CODE_BLOCK_PANDOC_LUA_FILTER_FILE = PANDOC_LUA_FILTERS_DIR / "trim_code_block.lua"
MAKE_LATEX_CODE_PANDOC_LUA_FILTER_FILE = PANDOC_LUA_FILTERS_DIR / "make_latex_code.lua"
